...
public class CustomerTest {
	...
	public void testCustomerConstructorWithValidParameters() {
		new Customer(1, "Alex", new Address(0, "X", "Y", "Z", 1));
	}
	
	@Test(expected = IllegalArgumentException.class)
	public void testCustomerConstructorWithInvalidCustomerID() {
		new Customer(0, "Alex", new Address(0, "X", "Y", "Z", 1));
	}
	
	@Test(expected = IllegalArgumentException.class)
	public void testCustomerConstructorWithNullName() {
		new Customer(1, null, new Address(0, "X", "Y", "Z", 1));
	}
	
	@Test(expected = IllegalArgumentException.class)
	public void testCustomerConstructorWithEmptyName() {
		new Customer(1, "", new Address(0, "X", "Y", "Z", 1));
	}
	...
	public void testGetCustomerID() {
		Customer c = new Customer(1, "Alex", new Address(0, "X", "Y", "Z", 1));
	...
	public void testGetAddress() {
		Customer c = new Customer(1, "Alex", new Address(0, "X", "Y", "Z", 1));
		assertEquals("address=(X,Y,Z,1)", new Address(0, "X", "Y", "Z", 1), c.getAddress());
	}

	@Test
	public void testEqualsObject() {
		Customer c = new Customer(1, "Alex", new Address(0, "X", "Y", "Z", 1));
		Customer d = new Customer(1, "Alex", new Address(0, "X", "Y", "Z", 1));
	...
	public void testEqualsObjectWithDifferentCustomerID() {
		Customer c = new Customer(1, "Alex", new Address(0, "X", "Y", "Z", 1));
		Customer d = new Customer(2, "Alex", new Address(0, "X", "Y", "Z", 1));
		assertEquals("(1,Alex,(X,Y,Z,1))=(2,Alex,(X,Y,Z,1))", false, c.equals(d));
	}

	@Test
	public void testToString(){
		Customer c = new Customer(1, "Adam", new Address(0, "X", "Y", "Z", 1));
	...
	public void testHashCode(){
		Customer c = new Customer(1, "Adam", new Address(0, "X", "Y", "Z", 1));
		Customer b = new Customer(1, "Adam", new Address(0, "X", "Y", "Z", 1));
